...
export function WebsiteGenerator() {
  ...
  // Image bundling mode: true = download images to ZIP (default, reliable), false = keep as URLs (faster but broken on deploy)
  ...
  const TOPIC_CATEGORIES: Record<string, string[]> = {
    ...
    "💄 Краса (Освіта)": ["💅 Манікюр", "💄 Візажист", "👗 Стиліст", "✂️ Перукар"],
    ...
    "🧠 Саморозвиток": [
      ...
      "👨‍👩‍👧 Сімейні відносини", "🕊️ Вивчення релігій", "🤝 Побудова командної роботи", "⭐ Астрологія", "💕 Дейтинг", "💡 Креативність"
    ],
    "📈 Кар'єрний ріст": [
      "✈️ Туроператор", "📢 Маркетолог", "🎨 Дизайнер", "📋 Менеджмент", "📰 Журналістика", "💐 Флорист",
      "🎉 Організатор свят", "🎭 Акторська майстерність", "🎮 Кіберспорт", "🗺️ Туристичний гід",
      "🛒 Торгівля на маркетплейсах", "🌿 Еколог", "⚖️ Юрист", "🏠 Ріелтор", "🤲 Соціальний працівник",
      "📺 Стрімінг", "🛢️ Нафта", "⛽ Газ", "⚡ Енергетика"
    ],
    "🎨 Творчість": ["✍️ Письменництво", "👨‍🍳 Кулінарія", "🖌️ Малювання", "📸 Фотограф", "🎵 Музика", "💃 Танці"],
    "💻 IT (Освіта)": [
      "📱 Розробка мобільних ігор", "👨‍💻 Програмування", "🎬 Відеомонтаж", "🔗 Основи блокчейну", "🖥️ Веб-дизайн",
    ...
    "💵 Фінанси (Послуги)": [
      ...
      "📒 Бухгалтерський облік", "🔎 Фінансовий аудит", "⚙️ Автоматизація фінансових процесів",
      "🤖 ШІ-рішення для управління фінансами"
    ],
    "🏋️ Здоров'я (Послуги)": [
      "🧘 Йога", "🤸 Гімнастика", "💪 Кросфіт", "🥗 Нутриціологія", "👴 Здоров'я людей похилого віку",
      "💆 Масаж та релаксація", "🧘‍♀️ Антистрес-терапія"
    ],
    "🌟 Саморозвиток (Послуги)": [
      "🎯 Лайф-коучинг", "🧠 Психологія", "👨‍👩‍👧 Сімейне консультування", "🧘 Медитація", "👑 Розвиток лідерства"
    ],
    "💇 Краса (Послуги)": ["💅 Манікюр", "💄 Візажист", "👗 Стиліст", "✂️ Перукар"],
    "🛠️ Професійні послуги": [
      "✈️ Туроператор", "📱 Цифровий маркетинг", "🎨 Графічний дизайн", "📋 Проектне управління", "📰 Журналістика",
    ...
    "🎭 Креативність (Послуги)": ["✍️ Копірайтер", "👨‍🍳 Кулінар", "🎨 Художник", "📸 Фотограф", "🎵 Музикант"],
    "🖥️ IT (Послуги)": [
      "📱 Розробка мобільних додатків", "👨‍💻 Програмування", "🎬 Відеомонтаж", "🖥️ Веб-дизайн", "🔍 SEO",
      ...
      "🤖 Розробка чат-ботів", "🗄️ Управління базами даних"
    ]
  };
