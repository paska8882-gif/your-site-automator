...
**Hero background:** 
url('https://image.pollinations.ai/prompt/[THEME]%20professional%20business%20photo?width=1920&height=1080&seed=1&nologo=true')
...
Add onerror handler to EVERY <img> tag to fallback to picsum.photos if Pollinations fails:
<img src="https://image.pollinations.ai/prompt/description?width=800&height=600&seed=1&nologo=true" onerror="this.onerror=null;this.src='https://picsum.photos/800/600?random=1'" alt="..." loading="lazy">

For CSS background images, no fallback needed.
`.trim();
