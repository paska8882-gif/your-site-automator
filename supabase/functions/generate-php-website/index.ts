...
- PHP example in config.php: define('SITE_HOURS', 'Mon-Fri: 9:00 AM - 6:00 PM');
- HTML example: <div class="footer-hours"><strong>Working Hours:</strong> <?php echo SITE_HOURS; ?></div>
